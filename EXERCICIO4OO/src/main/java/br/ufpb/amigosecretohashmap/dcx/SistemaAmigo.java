...
public class SistemaAmigo extends Amigo {
    ...
    public void configuraAmigoSecretoDe(String emailDaPessoa, String emailAmigoSorteado) throws AmigoInexisenteException{
        for( Amigo a: amigos){
            if(a.getEmail().equals(emailDaPessoa)){
                a.setEmailAmigoSorteado(emailAmigoSorteado);

            }
        } throw new AmigoInexisenteException("Amigo Inexistente");
    ...
    public String pesquisaAmigoSecretoDe(String emailDaPessoa) throws AmigoInexisenteException, AmigoNaoSorteadoException{
        for (Amigo a: amigos){
            if(a.getEmail().equals(emailDaPessoa)){
